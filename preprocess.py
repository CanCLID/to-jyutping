...
os.system('wget -nc https://raw.githubusercontent.com/rime/rime-cantonese/42aed00/jyut6ping3.dict.yaml')
...
def write_dict(d):
    with open('src/dictionary.txt', 'w') as f:
        for k, v in d.items():
            print(k + '\t' + v, file=f)
